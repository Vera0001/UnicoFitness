...
const moves = {
    Front_Kick: {
        ...
        timerVideos: ['videos/stretch 2.mp4', 'videos/stretch 3.mp4', 'videos/stretching.mp4'], // Array of different videos for timer
        description: 'The basic movement in capoeira that keeps you in constant motion.',
        currentIndex: 0 // Track the current video index
    },
    Reverse_Hook_Kick: {
        video: 'videos/Reverse hook kick.mp4',
    ...
    Spinning_Hook_Kick: {
        video: 'videos/spinning hook kick.mp4',
