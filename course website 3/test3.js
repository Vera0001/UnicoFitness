...
const moves = {
    Flying_High_Kick: {
        video: 'videos/FlyingFrontkick.mp4',
        timerVideos: ['videos/warmup.mp4', 'videos/warmup2.mp4', 'videos/warmup3.mp4'], // Array of different videos for timer
        description: 'The basic movement in capoeira that keeps you in constant motion.',
        currentIndex: 0 // Track the current video index
    },
    Dragon_Squat: {
        video: 'videos/Pistolsquat.mp4',
        timerVideos: ['videos/warmup.mp4', 'videos/warmup2.mp4', 'videos/warmup3.mp4'], // Array of different videos for timer
